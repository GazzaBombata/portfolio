...
<body class="px-5 md:px-auto">
            ...
            <div class="w-100% sm:w-[50%] flex flex-col items-center justify-center">
              <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div
                  ...
                  Looking for the CV? <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0"
                      aria-hidden="true"></span>Download PDF <span aria-hidden="true">&rarr;</span></a>
                </div>
              </div>
              <div class="text-center gap-5px py-10">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">An Ops manager, entrepreneur and intrapreneur turned
                  Full Stack Developer. Sounds extravagant? Contact me and find it out.</p>
  ...
  <div class="flex flex-col items-center justify-items-center space-y-10 py-10" id="projects">
    ...
    <div class="flex flex-row items-center justify-items-center space-x-10 py-10 max-h-max">
      ...
      <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
          ...
          <div class="p-5">
              <a href="#">
                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Congresso Rotary 2024</h5>
              </a>
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Rotary event website. Registrations, Presences and feedback management. Built with Laravel, MySQL and Blade</p>
              <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white text-white bg-gray-300 rounded focus:outline-none rounded-lg">
                  WIP
                  <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                  </svg>
      ...
      <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="p-5">
              <a href="https://integral-hold-411309.oa.r.appspot.com">
                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Tablebooks</h5>
              </a>
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Restaurant table reservations SaaS. Start2Impact final project. Built with NodeJS, MySQL and React, hosted on GCP.</p>
              <a href="https://integral-hold-411309.oa.r.appspot.com" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Visit
                  <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                  </svg>
  ...
  <div class="flex flex-col items-center justify-items-center space-y-10 py-10" id="work-experience">
    <h2 class="text-4xl font-bold dark:text-white">Work Experience</h2>
    <ol class="relative border-s border-gray-200 dark:border-gray-700">
      <li class="mb-10 ms-6">
        ...
        <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Full Stack Developer Freelance<span
            class="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Current</span>
        </h3>
        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Started on February
          2024</time>
        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Leveraging Software to bring Business Operations to the next level.</p>
        <a href="#"
      ...
      <li class="mb-10 ms-6">
        ...
        <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Operations and Tech - Quisto</h3>
        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">From May 2023 to January 2024</time>
        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Operations Manager and builder of internal tech tools.</p>
      ...
      <li class="mb-10 ms-6">
        ...
        <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Founder - Gluebus</h3>
        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">From February 2022 to May 2023</time>
        <p class="text-base font-normal text-gray-500 dark:text-gray-400">Smart Bus Platform for local night events, part of StartupBootcamp Amsterdam 2022 batch.</p>
      </li>
      <li class="mb-10 ms-6">
        <span
          class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
      ...
      <li class="mb-10 ms-6">
        ...
        <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Area Manager - Everli</h3>
        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">From April 2019 to July 2020</time>
        <p class="text-base font-normal text-gray-500 dark:text-gray-400">Area Management of Brescia, Verona, Mantova and Cremona areas. Responsible for quality of deliveries and shopper supply.</p>
      </li>
      <li class=" ms-6">
        <span
          class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
        ...
        <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Business Processes Intern - Esselunga</h3>
        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">From January 2018 to July 2018</time>
        <p class="text-base font-normal text-gray-500 dark:text-gray-400">Responsible for mapping and optimization of logistic processes and quality checks.</p>
      </li>
    </ol>
  </div>
  ...
  <!-- drawer component -->
  <div id="drawer-form"
    class="z-10000 fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800"
    ...
    <form class="mb-6">
      <div class="mb-6">
        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">What is your name?</label>
      ...
      <div class="mb-6">
        <label for="description"
          class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Inquiry</label>
      ...
      <div class="mb-4">
        <label for="guests" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Email</label>
        <div class="relative">
